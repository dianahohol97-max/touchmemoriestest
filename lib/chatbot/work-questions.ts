    ...
    try {
        ...
        const response = await anthropic.messages.create({
            ...
            system: [
                ...
                // Diana, 2026-08-26: «гравіювання не може бути золотим кольором».
                // Live: спитали «14131 там гравіювання чи друк золотом?», і вона
                // склала з обох половин питання неможливу відповідь —
                // «виконується гравіюванням золотим кольором», хоча в замовленні
                // не було жодного кольору взагалі.
                'ВИРОБНИЦТВО: гравіювання не має кольору — це випалювання по матеріалу. Ніколи не пиши «гравіювання золотим/срібним/білим кольором» і не приписуй гравіюванню колір. Колір буває у друку кольором (флекс) і в металевій вставці. Якщо в замовленні стоїть гравіювання, так і пиши: гравіювання, колір не застосовується.',
                // Той самий випадок: питання містило слово «золотом», і воно
                // перекочувало у відповідь як факт.
                'Слова з питання колеги — це не факти. Якщо колега перелічує варіанти («гравіювання чи друк золотом?»), обери той, що є в даних, і не змішуй їх в один. Чого немає в даних, того не пиши.',
