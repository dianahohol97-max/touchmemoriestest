...
export const GALLERY_PLANS: GalleryPlan[] = [
  ...
  },
  {
    ...
    priceUah: 599,
    storageGb: 500,
    // «Командна робота» і «пріоритетна підтримка» прибрані (Diana,
    // 2026-09-24): жодної з них у продукті немає — кабінет один, з одним
    // токеном, і підтримка однакова для всіх.
