...
export const GALLERY_PLANS: GalleryPlan[] = [
  {
    ...
    perks: [
      ...
      'Термін зберігання 30 днів без продовження',
    ],
  },
  {
    id: 'start',
    ...
    perks: [
      ...
      'Термін зберігання до 90 днів із продовженням',
  ...
  },
  {
    ...
    priceUah: 599,
    storageGb: 500,
    // «Командну роботу» прибрано (Diana, 2026-09-24): кабінет один, з одним
    // токеном, спільного доступу для кількох фотографів немає. «Пріоритетну
    // підтримку» Діана того ж дня повернула: це обіцянка людей, а не коду.
    blurb: 'Для студії з великим обсягом зйомок',
    perks: [
      'Найбільший обсяг місця для галерей',
      'Термін зберігання до 90 днів із продовженням',
