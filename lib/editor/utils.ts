...
export function detectDecoType(decoString: string): CoverDecoType {
  ...
  if (deco.includes('флекс') || deco.includes('flex') || deco.includes('друк кольор')) return 'flex';
...
export function buildCoverEditorProps(
  ...
  return {
    ...
    photoCropX: (coverState as any).photoCropX,
    photoCropY: (coverState as any).photoCropY,
    photoZoom: (coverState as any).photoZoom,
    photoRotation: (coverState as any).photoRotation,
...
export function handleCoverChange(
  ...
  return {
    ...
    ...((cfg as any).photoCropX !== undefined && { photoCropX: (cfg as any).photoCropX }),
    ...((cfg as any).photoCropY !== undefined && { photoCropY: (cfg as any).photoCropY }),
    ...((cfg as any).photoZoom !== undefined && { photoZoom: (cfg as any).photoZoom }),
    ...((cfg as any).photoRotation !== undefined && { photoRotation: (cfg as any).photoRotation }),
