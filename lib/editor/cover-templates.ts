...
export const COVER_TEMPLATES: CoverTemplate[] = [
  ...
  //  Wishbook — additional trending designs 
  {
    ...
    texts: [
      ...
      { text: '2025', x: 50, y: 86, fontSize: 12, fontFamily: 'Montserrat', color: '#6a8a4a', bold: false },
    ],
  },
  {
    id: 'wish-dusty-rose',
    label: 'Припилена троянда',
    group: 'Книга побажань — Весільні',
    tags: ['wishbook'],
    bgColor: '#e8d0ce',
    photoSlot: null,
    texts: [
      ...
      { text: '15.06.2025', x: 50, y: 85, fontSize: 12, fontFamily: 'Cormorant Garamond', color: '#8a4a4a', bold: false },
    ],
  },
  {
    id: 'wish-midnight',
  ...
  },
  {
    ...
    photoSlot: null,
    texts: [
      { text: '— • —', x: 50, y: 18, fontSize: 14, fontFamily: 'Playfair Display', color: '#b8944a', bold: false },
      { text: 'WEDDING', x: 50, y: 35, fontSize: 14, fontFamily: 'Montserrat', color: '#8a6424', bold: true },
      { text: 'Celebration', x: 50, y: 50, fontSize: 34, fontFamily: 'Great Vibes', color: '#8a6424', bold: false },
      { text: "Ім'я & Ім'я", x: 50, y: 72, fontSize: 14, fontFamily: 'Playfair Display', color: '#5a4414', bold: false, italic: true },
      { text: '2025 • GUEST BOOK', x: 50, y: 85, fontSize: 10, fontFamily: 'Montserrat', color: '#8a6424', bold: true },
    ],
  },
  {
    id: 'wish-rustic',
    ...
    photoSlot: null,
    texts: [
      { text: '~~~', x: 50, y: 20, fontSize: 18, fontFamily: 'Dancing Script', color: '#6a4a2a', bold: false },
      { text: 'THE', x: 50, y: 33, fontSize: 14, fontFamily: 'Montserrat', color: '#5a3a1a', bold: true },
      { text: 'Wedding', x: 50, y: 48, fontSize: 36, fontFamily: 'Dancing Script', color: '#5a3a1a', bold: false },
      { text: '~ of ~', x: 50, y: 60, fontSize: 14, fontFamily: 'Cormorant Garamond', color: '#6a4a2a', bold: false, italic: true },
      { text: "Ім'я & Ім'я", x: 50, y: 74, fontSize: 16, fontFamily: 'Cormorant Garamond', color: '#3a1a0a', bold: false },
      { text: '2025', x: 50, y: 87, fontSize: 12, fontFamily: 'Montserrat', color: '#5a3a1a', bold: false },
    ],
  },
  {
    id: 'wish-typographic',
    ...
    photoSlot: null,
    texts: [
      { text: 'WRITE', x: 50, y: 22, fontSize: 14, fontFamily: 'Montserrat', color: '#1a1a1a', bold: true },
      { text: 'YOUR', x: 50, y: 32, fontSize: 14, fontFamily: 'Montserrat', color: '#1a1a1a', bold: true },
      { text: 'wishes', x: 50, y: 50, fontSize: 42, fontFamily: 'Dancing Script', color: '#8a6030', bold: false },
      { text: '— HERE —', x: 50, y: 68, fontSize: 12, fontFamily: 'Montserrat', color: '#1a1a1a', bold: true },
      { text: 'GUEST BOOK • 2025', x: 50, y: 87, fontSize: 10, fontFamily: 'Montserrat', color: '#5a5a5a', bold: false },
    ],
  },
  {
    id: 'wish-script-large',
    label: 'Великий скрипт',
    group: 'Книга побажань',
    tags: ['wishbook'],
    bgColor: '#ffffff',
    photoSlot: null,
    texts: [
      { text: 'Our', x: 50, y: 30, fontSize: 44, fontFamily: 'Great Vibes', color: '#1a1a1a', bold: false },
      { text: 'Wedding', x: 50, y: 48, fontSize: 44, fontFamily: 'Great Vibes', color: '#1a1a1a', bold: false },
      { text: '— Guest Book —', x: 50, y: 68, fontSize: 14, fontFamily: 'Playfair Display', color: '#8a6a3a', bold: false, italic: true },
      { text: "Ім'я & Ім'я", x: 50, y: 80, fontSize: 12, fontFamily: 'Montserrat', color: '#5a5a5a', bold: true },
      { text: '15 • 06 • 2025', x: 50, y: 90, fontSize: 11, fontFamily: 'Cormorant Garamond', color: '#8a6a3a', bold: false, italic: true },
    ],
  },
  {
    id: 'wish-geometric',
  ...
  },
  {
    ...
    texts: [
      ...
      { text: "Ім'я & Ім'я", x: 50, y: 85, fontSize: 13, fontFamily: 'Cormorant Garamond', color: '#5a3a1a', bold: false, italic: true },
    ],
  },
  {
    id: 'wish-watercolor',
    ...
    texts: [
      ...
      { text: "Ім'я & Ім'я • 2025", x: 50, y: 87, fontSize: 11, fontFamily: 'Cormorant Garamond', color: '#5a2030', bold: false },
    ],
  },
];
