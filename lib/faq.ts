...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'Кількість правок необмежена і безкоштовна. Ви можете вносити зміни до моменту фінального затвердження. Повна переробка макету (зміна концепції або структури) коштуватиме +250 грн.',
  },
  {
