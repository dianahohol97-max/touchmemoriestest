...
const saveBtnStyle = { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', backgroundColor: '#263A99', color: 'white', borderRadius: '3px', fontWeight: 700, border: 'none', cursor: 'pointer', fontSize: '15px' };
...
const inputStyle = { width: '100%', padding: '12px 16px', borderRadius: '3px', border: '1.5px solid #e2e8f0', outline: 'none', fontSize: '15px', color: '#263A99', transition: 'border-color 0.2s' };
...
const selectorItemStyle = { display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 12px', borderRadius: '3px', border: '1.5px solid #e2e8f0', fontSize: '13px', fontWeight: 600, color: '#475569', cursor: 'pointer', transition: 'all 0.2s' };
