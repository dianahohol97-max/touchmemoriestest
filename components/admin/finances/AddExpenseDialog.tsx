...
import type { ExpenseCategory, ExpenseFormData, Currency, RecurringInterval } from '@/lib/types/expenses';
...
export function AddExpenseDialog({ open, onOpenChange, categories, onSuccess }: AddExpenseDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Додати витрату</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <Input
                ...
                required
                placeholder="Наприклад: Facebook Ads листопад"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Наприклад: Meta Ads"
              />
            </div>
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? 'Збереження...' : 'Додати витрату'}
            </Button>
          </div>
        </form>
      </DialogContent>
