...
export default function BookLayoutEditor() {
  ...
  const addToCart = async () => {
    ...
    try {
      ...
      // ТЕКСТ, ЯКИЙ НАДРУКУЄТЬСЯ НЕ ТИМ ШРИФТОМ.
      //
      // Три родини в підбірці стояли з прапорцем кирилиці, не маючи жодного
      // кириличного гліфа: Lato, Poppins і Schibsted Grotesk. Окремо — родина,
      // якої в нашому наборі немає взагалі (Georgia): така підміняється цілком.
