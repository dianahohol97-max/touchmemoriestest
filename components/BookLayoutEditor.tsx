...
import { normalizeImageFile, readImageSignature, needsHeicConversion } from '@/lib/heic-to-jpeg';
...
// The editor's data model lives in lib/editor/types.ts — these shapes used
// to be re-declared here and the two copies drifted (PhotoData 5 fields vs
// 13, SlotData 5 vs 11, LayoutType `string` vs the real union). Import, do
// not re-declare.
...
const LAYOUTS: { id: LayoutType; label: string; slots: number; group: string }[] = [
  ...
  // 7-9 фото
  { id: 'p-7-grid',       label: '7 сітка',           slots: 7, group: '7 фото' },
  { id: 'p-8-grid',       label: '8 сітка',           slots: 8, group: '8 фото' },
  { id: 'p-9-grid',       label: '9 рівно (3×3)',     slots: 9, group: '9 фото' },
  // Текст
  ...
  { id: 'sp-1-left-wide', label: 'Широке ліворуч',      slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-right-wide',label: 'Широке праворуч',     slots: 1, group: 'Розворот 1 фото' },
  ...
  { id: 'sp-2-left-pair', label: '2 ліворуч стопкою',   slots: 2, group: 'Розворот 2 фото' },
  { id: 'sp-2-right-pair',label: '2 праворуч стопкою',  slots: 2, group: 'Розворот 2 фото' },
  { id: 'sp-2-diag',      label: '2 по діагоналі',      slots: 2, group: 'Розворот 2 фото' },
  ...
  { id: 'sp-3-l-shape',   label: 'L-форма',             slots: 3, group: 'Розворот 3 фото' },
  { id: 'sp-3-t-shape',   label: 'Т-форма',             slots: 3, group: 'Розворот 3 фото' },
  { id: 'sp-3-center',    label: '1 центр + 2 бічні',   slots: 3, group: 'Розворот 3 фото' },
  ...
  { id: 'sp-4-strip-v',   label: '4 смуги вертикал',    slots: 4, group: 'Розворот 4 фото' },
  { id: 'sp-4-mosaic',    label: '4 мозаїка',           slots: 4, group: 'Розворот 4 фото' },
  { id: 'sp-4-hero-top',  label: 'Велике зверху + 3',   slots: 4, group: 'Розворот 4 фото' },
  { id: 'sp-4-hero-bottom',label:'3 зверху + велике',    slots: 4, group: 'Розворот 4 фото' },
  { id: 'sp-5-grid',      label: '5 сітка',             slots: 5, group: 'Розворот 5+ фото' },
  { id: 'sp-5-hero',      label: 'Велике + 4',          slots: 5, group: 'Розворот 5+ фото' },
  { id: 'sp-5-quilt',     label: '5 клаптик',           slots: 5, group: 'Розворот 5+ фото' },
  { id: 'sp-5-strip',     label: '5 смуг',              slots: 5, group: 'Розворот 5+ фото' },
  { id: 'sp-6-grid',      label: '6 рівно (3×2)',       slots: 6, group: 'Розворот 5+ фото' },
  { id: 'sp-6-hero',      label: 'Велике + 5',          slots: 6, group: 'Розворот 5+ фото' },
  { id: 'sp-6-mosaic',    label: '6 мозаїка',           slots: 6, group: 'Розворот 5+ фото' },
  { id: 'sp-7-grid',      label: '7 сітка (4+3)',       slots: 7, group: 'Розворот 5+ фото' },
  { id: 'sp-7-hero',      label: 'Велике + 6',          slots: 7, group: 'Розворот 5+ фото' },
  { id: 'sp-8-grid',      label: '8 сітка (4×2)',       slots: 8, group: 'Розворот 5+ фото' },
  { id: 'sp-8-mosaic',    label: '8 мозаїка',           slots: 8, group: 'Розворот 5+ фото' },
  { id: 'sp-9-grid',      label: '9 сітка (3×3)',       slots: 9, group: 'Розворот 5+ фото' },
  ...
  // 1 фото — додаткові (6→15)
  { id: 'p-1-top-strip',    label: 'Смуга зверху',        slots: 1, group: '1 фото' },
  { id: 'p-1-bottom-strip', label: 'Смуга знизу',         slots: 1, group: '1 фото' },
  { id: 'p-1-left-wide',    label: 'Широке ліворуч',      slots: 1, group: '1 фото' },
  { id: 'p-1-right-wide',   label: 'Широке праворуч',     slots: 1, group: '1 фото' },
  { id: 'p-1-polaroid',     label: 'Polaroid',            slots: 1, group: '1 фото' },
  { id: 'p-1-portrait',     label: 'Портрет по центру',   slots: 1, group: '1 фото' },
  { id: 'p-1-landscape',    label: 'Пейзаж по центру',    slots: 1, group: '1 фото' },
  { id: 'p-1-corner-tl',    label: 'Кут ліво-верх',       slots: 1, group: '1 фото' },
  { id: 'p-1-corner-br',    label: 'Кут право-низ',       slots: 1, group: '1 фото' },
  // 2 фото — додаткові (7→15)
  { id: 'p-2-overlap',      label: '2 внахлест',          slots: 2, group: '2 фото' },
  { id: 'p-2-top-strip',    label: 'Смуга + повне фото',  slots: 2, group: '2 фото' },
  { id: 'p-2-bottom-strip', label: 'Повне фото + смуга',  slots: 2, group: '2 фото' },
  { id: 'p-2-75-25',        label: '¾ + ¼',               slots: 2, group: '2 фото' },
  { id: 'p-2-25-75',        label: '¼ + ¾',               slots: 2, group: '2 фото' },
  { id: 'p-2-center-pair',  label: '2 по центру',         slots: 2, group: '2 фото' },
  { id: 'p-2-cinema',       label: 'Кіностиль',           slots: 2, group: '2 фото' },
  { id: 'p-2-frame',        label: 'Фото у рамці',        slots: 2, group: '2 фото' },
  // 3 фото — додаткові (8→15)
  { id: 'p-3-hero-right',   label: 'Велике + 2 ліво',     slots: 3, group: '3 фото' },
  { id: 'p-3-strip-top',    label: 'Смуга + 2 знизу',     slots: 3, group: '3 фото' },
  { id: 'p-3-strip-bot',    label: '2 зверху + смуга',    slots: 3, group: '3 фото' },
  { id: 'p-3-diagonal',     label: '3 по діагоналі',      slots: 3, group: '3 фото' },
  { id: 'p-3-mosaic',       label: '3 мозаїка',           slots: 3, group: '3 фото' },
  { id: 'p-3-featured',     label: 'Акцент центр',        slots: 3, group: '3 фото' },
  { id: 'p-3-panorama',     label: 'Панорама + 2',        slots: 3, group: '3 фото' },
  // 4 фото — додаткові (6→15)
  { id: 'p-4-mosaic',       label: '4 мозаїка',           slots: 4, group: '4 фото' },
  { id: 'p-4-top-bottom',   label: '2 зверху + 2 знизу',  slots: 4, group: '4 фото' },
  { id: 'p-4-corner',       label: '4 по кутах',          slots: 4, group: '4 фото' },
  { id: 'p-4-cinema',       label: '4 кінострічка',       slots: 4, group: '4 фото' },
  { id: 'p-4-focus',        label: '1 велике + 3 малих',  slots: 4, group: '4 фото' },
  { id: 'p-4-row-top',      label: '3 зверху + велике',   slots: 4, group: '4 фото' },
  { id: 'p-4-hero-bottom',  label: '3 зверху + велике',   slots: 4, group: '4 фото' },
  { id: 'p-4-cross',        label: 'Хрест',               slots: 4, group: '4 фото' },
  { id: 'p-4-uneven',       label: '1 + 3 нерівно',       slots: 4, group: '4 фото' },
  // 5 фото — додаткові (3→15)
  { id: 'p-5-col',          label: '5 стовпець',          slots: 5, group: '5 фото' },
  { id: 'p-5-row',          label: '5 рядок',             slots: 5, group: '5 фото' },
  { id: 'p-5-2-3',          label: '2 зверху + 3 знизу',  slots: 5, group: '5 фото' },
  { id: 'p-5-3-2',          label: '3 зверху + 2 знизу',  slots: 5, group: '5 фото' },
  { id: 'p-5-mosaic',       label: '5 мозаїка',           slots: 5, group: '5 фото' },
  { id: 'p-5-focus',        label: '1 велике + 4 малих',  slots: 5, group: '5 фото' },
  { id: 'p-5-big-left',     label: 'Велике ліво + 4',     slots: 5, group: '5 фото' },
  { id: 'p-5-big-right',    label: '4 + велике право',    slots: 5, group: '5 фото' },
  { id: 'p-5-cross',        label: '5 хрест',             slots: 5, group: '5 фото' },
  { id: 'p-5-panorama',     label: 'Панорама + 4',        slots: 5, group: '5 фото' },
  { id: 'p-5-diagonal',     label: '5 діагональ',         slots: 5, group: '5 фото' },
  { id: 'p-5-corner',       label: '4 кути + центр',      slots: 5, group: '5 фото' },
  // 6 фото — додаткові (3→15)
  { id: 'p-6-strip-h',      label: '6 горизонт смуги',    slots: 6, group: '6 фото' },
  { id: 'p-6-strip-v',      label: '6 вертик смуги',      slots: 6, group: '6 фото' },
  { id: 'p-6-mosaic',       label: '6 мозаїка',           slots: 6, group: '6 фото' },
  { id: 'p-6-hero-top',     label: 'Велике + 5 знизу',    slots: 6, group: '6 фото' },
  { id: 'p-6-hero-left',    label: 'Велике + 5 право',    slots: 6, group: '6 фото' },
  { id: 'p-6-cols',         label: '3 стовпці × 2',       slots: 6, group: '6 фото' },
  { id: 'p-6-focus',        label: '1 велике + 5 малих',  slots: 6, group: '6 фото' },
  { id: 'p-6-2-4',          label: '2 зверху + 4 знизу',  slots: 6, group: '6 фото' },
  { id: 'p-6-4-2',          label: '4 зверху + 2 знизу',  slots: 6, group: '6 фото' },
  { id: 'p-6-diagonal',     label: '6 діагональ',         slots: 6, group: '6 фото' },
  { id: 'p-6-magazine',     label: 'Журнальний стиль',    slots: 6, group: '6 фото' },
  { id: 'p-6-uneven',       label: '6 нерівний',          slots: 6, group: '6 фото' },
  // 7 фото
  { id: 'p-7-hero',         label: 'Велике + 6',          slots: 7, group: '7 фото' },
  { id: 'p-7-3-4',          label: '3 зверху + 4 знизу',  slots: 7, group: '7 фото' },
  { id: 'p-7-4-3',          label: '4 зверху + 3 знизу',  slots: 7, group: '7 фото' },
  ...
  // 8 фото
  { id: 'p-8-hero',         label: 'Велике + 7',          slots: 8, group: '8 фото' },
  { id: 'p-8-2x4',          label: '2 ряди × 4',          slots: 8, group: '8 фото' },
  { id: 'p-8-mosaic',       label: '8 мозаїка',           slots: 8, group: '8 фото' },
  { id: 'p-8-strip-v',      label: '8 вертик смуги',      slots: 8, group: '8 фото' },
  { id: 'p-8-focus',        label: '1 велике + 7 малих',  slots: 8, group: '8 фото' },
  { id: 'p-8-cols',         label: '8 (4+4 стовпці)',     slots: 8, group: '8 фото' },
  { id: 'p-8-row',          label: '8 рядок',             slots: 8, group: '8 фото' },
  { id: 'p-8-col',          label: '8 стовпець',          slots: 8, group: '8 фото' },
  { id: 'p-8-4-4',          label: '4 зверху + 4 знизу',  slots: 8, group: '8 фото' },
  { id: 'p-8-big-top',      label: 'Велике зверху + 7',   slots: 8, group: '8 фото' },
  { id: 'p-8-big-left',     label: 'Велике ліво + 7',     slots: 8, group: '8 фото' },
  { id: 'p-8-panorama',     label: 'Панорама + 7',        slots: 8, group: '8 фото' },
  { id: 'p-8-uneven',       label: '8 нерівний',          slots: 8, group: '8 фото' },
  { id: 'p-8-cross',        label: '8 хрест',             slots: 8, group: '8 фото' },
  { id: 'p-8-3-5',          label: '3 зверху + 5 знизу',  slots: 8, group: '8 фото' },
  { id: 'p-8-5-3',          label: '5 зверху + 3 знизу',  slots: 8, group: '8 фото' },
  { id: 'p-8-magazine',     label: 'Журнальний 8',        slots: 8, group: '8 фото' },
  { id: 'p-8-strip-h',      label: '8 горизонт смуги',    slots: 8, group: '8 фото' },
  { id: 'p-8-corner',       label: '1 велике + 7 по краях',slots: 8, group: '8 фото' },
  { id: 'p-8-diagonal',     label: '8 діагональ',         slots: 8, group: '8 фото' },
  // 9 фото
  { id: 'p-9-hero',         label: 'Велике + 8',          slots: 9, group: '9 фото' },
  { id: 'p-9-mosaic',       label: '9 мозаїка',           slots: 9, group: '9 фото' },
  { id: 'p-9-strip',        label: '9 смуг',              slots: 9, group: '9 фото' },
  { id: 'p-9-focus',        label: '1 велике + 8 малих',  slots: 9, group: '9 фото' },
  { id: 'p-9-cols',         label: '9 (3×3 стовпці)',     slots: 9, group: '9 фото' },
  { id: 'p-9-3-3-3',       label: '3 рядки по 3',        slots: 9, group: '9 фото' },
  { id: 'p-9-hero-top',    label: 'Велике зверху + 8',   slots: 9, group: '9 фото' },
  { id: 'p-9-big-left',    label: 'Велике ліво + 8',     slots: 9, group: '9 фото' },
  { id: 'p-9-magazine',    label: 'Журнальний 9',        slots: 9, group: '9 фото' },
  { id: 'p-9-diagonal',    label: '9 діагональ',         slots: 9, group: '9 фото' },
  { id: 'p-9-4-5',         label: '4 зверху + 5 знизу',  slots: 9, group: '9 фото' },
  { id: 'p-9-5-4',         label: '5 зверху + 4 знизу',  slots: 9, group: '9 фото' },
  { id: 'p-9-strip-h',     label: '9 горизонт смуги',    slots: 9, group: '9 фото' },
  // Розворот 1 фото — додаткові (8→15)
  { id: 'sp-1-polaroid',       label: 'Polaroid центр',      slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-portrait',       label: 'Портрет центр',       slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-landscape',      label: 'Пейзаж центр',        slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-corner-tl',      label: 'Кут ліво-верх',       slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-corner-br',      label: 'Кут право-низ',       slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-left-strip',     label: 'Смуга ліворуч',       slots: 1, group: 'Розворот 1 фото' },
  { id: 'sp-1-right-strip',    label: 'Смуга праворуч',      slots: 1, group: 'Розворот 1 фото' },
  // Розворот 2 фото — додаткові (12→15)
  { id: 'sp-2-triptych',       label: 'Триптих центр',       slots: 2, group: 'Розворот 2 фото' },
  { id: 'sp-2-overlap',        label: '2 внахлест',          slots: 2, group: 'Розворот 2 фото' },
  { id: 'sp-2-frame',          label: '2 у рамках',          slots: 2, group: 'Розворот 2 фото' },
  // Розворот 3 фото — додаткові (12→15)
  { id: 'sp-3-magazine',       label: 'Журнальний',          slots: 3, group: 'Розворот 3 фото' },
  { id: 'sp-3-focus',          label: '1 велике + 2 смуги',  slots: 3, group: 'Розворот 3 фото' },
  { id: 'sp-3-diagonal',       label: '3 по діагоналі',      slots: 3, group: 'Розворот 3 фото' },
  // Розворот 4 фото — додаткові (12→15)
...
function KalkaCalendar({ mode = 'year', year, month = 0, color, font, baseFont, markedDays, onToggleDay }: { mode?: 'year' | 'month'; year: number; month?: number; color: string; font?: string; baseFont: number; markedDays?: number[]; onToggleDay?: (day: number) => void }) {
  const ff = font ? `"${font}", Georgia, serif` : 'Georgia, "Times New Roman", serif';
  // Single-month view — large, with optional circled dates.
  if (mode === 'month') {
    ...
    return (
      <div style={{ width: '100%', color, fontFamily: ff, textAlign: 'center', userSelect: 'none' }}>
        <div style={{ fontSize: f * 3.0, fontWeight: 700, letterSpacing: f * 0.15, lineHeight: 1 }}>{KALKA_UA_MONTHS[month]}</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', rowGap: f * 0.9, columnGap: f * 0.2, fontSize: f * 1.45, lineHeight: 1.15 }}>
          {KALKA_UA_WD.map((w, wi) => <div key={'w' + wi} style={{ fontWeight: 700, opacity: 0.5, fontSize: f * 1.05 }}>{w}</div>)}
          {cells.map((c, ci) => {
            if (!c) return <div key={ci} />;
            const marked = !!markedDays?.includes(c);
            return (
              <div key={ci}
                onClick={onToggleDay ? (e) => { e.stopPropagation(); onToggleDay(c); } : undefined}
                style={{ position: 'relative', cursor: onToggleDay ? 'pointer' : 'default', display: 'flex', alignItems: 'center', justifyContent: 'center', aspectRatio: '1 / 1' }}>
  ...
  // Full-year view — 12 small months.
...
export default function BookLayoutEditor() {
  ...
  const [kalkaState, setKalkaState] = useState<{ text: string; textColor: string; fontSize: number; fontFamily: string; bold: boolean; italic: boolean; textAlign: 'left' | 'center' | 'right'; textX: number; textY: number; imageUrl: string | null; imgCropX: number; imgCropY: number; imgZoom: number; imgScale: number; imgX: number; imgY: number; calendarEnabled: boolean; calendarMode: 'year' | 'month'; calendarYear: number; calendarMonth: number; calendarColor: string; calendarFont: string; calendarScale: number; calendarX: number; calendarY: number; calendarMarkedDays: number[]; }>({ text: '', textColor: '#333333', fontSize: 24, fontFamily: 'Playfair Display', bold: false, italic: false, textAlign: 'center', textX: 50, textY: 50, imageUrl: null, imgCropX: 50, imgCropY: 50, imgZoom: 1, imgScale: 80, imgX: 50, imgY: 50, calendarEnabled: false, calendarMode: 'month', calendarYear: new Date().getFullYear() + 1, calendarMonth: new Date().getMonth(), calendarColor: '#333333', calendarFont: 'Playfair Display', calendarScale: 94, calendarX: 50, calendarY: 50, calendarMarkedDays: [] });
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    // Тут є await (читання перших байтів кожного файлу), а після нього
    // звертатися до e.target уже ненадійно — беремо елемент один раз.
    ...
    //
    // Лічба йде ЗА БАЙТАМИ, тією самою умовою, що й сама конвертація
    // (needsHeicConversion). Поки вона йшла за розширенням, набір HEIC під
    // іменем `.jpg` конвертувався хвилину-дві без жодного тоста, і одну
    // поломку ми виміняли б на іншу.
    const signatures = await Promise.all(files.map(f => readImageSignature(f)));
    const heicCount = files.filter((f, i) => needsHeicConversion(f, signatures[i])).length;
  ...
  const onCanvasClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    pushHistory();
    setPages(prev => prev.map((p, i) => i !== currentIdx ? p : { ...p, textBlocks: [...p.textBlocks, { id, text: t('constructor.text'), x: ((e.clientX - rect.left) / cW) * 100, y: ((e.clientY - rect.top) / cH) * 100, fontSize: tFontSize, fontFamily: tFontFamily, color: tColor, bold: tBold, italic: tItalic, zOrder: nextOverlayZ(currentIdx) }] }));
  ...
  const addToCartInner = async () => {
    ...
    if (snapshots.length > 0) {
      ...
      // for soft-cover products. These come from the cover state's
      // decoType and the editor's photo list rather than the spread
      // snapshots, so they're generated programmatically rather than
      // via html2canvas. For printed-cover products or "Без оздоблення"
      // the helper returns an empty array and nothing extra is uploaded.
      try {
        const sizeKeyForInsets = getSizeKeyForProduct(config);
        const insetFiles = await renderInsetFiles({
          ...
          sizeKey: sizeKeyForInsets,
        });
        for (const item of insetFiles) {
          try {
            let insetBlob: Blob | null = await new Promise((resolve) => {
              item.canvas.toBlob((b) => resolve(b), 'image/jpeg', 0.98);
            });
            if (!insetBlob) continue;
...
//  Pricing (imported from @/lib/editor/pricing)
  ...
  if (isMagazine) {
    ...
    const result = calculateDynamicPrice(
      priceTable,
      config.selectedCoverType || t('constructor.velour'),
    ...
    <div className="tm-editor-root" style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#f4f6fb' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', flexDirection: isMobile ? 'column' : 'row', position:'relative' }}>
        ...
        {!isMobile && <div style={{ width: 72, background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 8, borderRight: '1px solid #f1f5f9', flexShrink: 0 }}>
          {((() => {
            const allTabs: [string, React.ReactNode, string, boolean?][] = [
              ...(!isWishbook ? [['layouts', <LayoutGrid key="l" size={20}/>, t('constructor.layout_tab')] as [string, React.ReactNode, string]] : []),
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
                  {photos.map((ph, i) => {
                    ...
                    return (
                      <div key={ph.id} draggable={true}
                        onDragStart={e => { const ids = isSel && selectedPhotoIds.size > 1 ? [...selectedPhotoIds] : [ph.id]; setDragPhotoId(ph.id); e.dataTransfer.setData('photoId', ph.id); e.dataTransfer.setData('photoIds', JSON.stringify(ids)); e.dataTransfer.setData('text/plain', ph.id); e.dataTransfer.effectAllowed='copy'; }}
            ...
            {leftTab === 'layouts' && (() => {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                ...
                {(isSpreadMode
                  ...
                  : ['1 фото', '2 фото', '3 фото', '4 фото', '5 фото', '6 фото', '7 фото', '8 фото', '9 фото', t('constructor.text')]
                ).map(group => {
            ...
            {leftTab === 'cover' && (
              <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
                  ...
                  return (
                    <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
                      ...
                      <div>
                        ...
                        <button onClick={()=>setCoverState(p=>({...p,printedTextBlocks:[...(p.printedTextBlocks||[]),{id:'ptxt-'+Date.now(),text:t('constructor.your_text'),x:50,y:50,fontSize:24,fontFamily:'Playfair Display',color:'#ffffff',bold:true}]}))}
                ...
                <div>
                  ...
                  {/* Cover color picker */}
                  {config?.selectedCoverType && config.selectedCoverType !== t('constructor.printed') && (() => {
                    ...
                    <div style={{ display:'flex', gap:8, alignItems:'center' }}>
                      ...
                      <input type="text" value={coverState.printedBgColor || '#ffffff'}
                        onChange={e => {
                          ...
                          setCoverState(p => ({...p, printedBgColor: v}));
                        }}
                        onBlur={e => {
                          let v = e.target.value.trim();
                          if (v && !v.startsWith('#')) v = '#' + v;
                        ...
                        placeholder="#ffffff"
                        style={{ flex:1, padding:'5px 8px', border:'1px solid #e2e8f0', borderRadius:6, fontSize:12, fontFamily:'monospace', color:'#374151', background:'#fff', outline:'none', minWidth:0 }}/>
                      <button onClick={()=>setCoverState(p=>({...p,printedBgColor:'#ffffff'}))}
                ...
                <div style={{ border:'1px solid #e2e8f0', borderRadius:8, padding:'10px', display:'flex', flexDirection:'column', gap:8 }}>
                  ...
                  {kalkaState.calendarEnabled && (
                    <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                      ...
                      {kalkaState.calendarMode==='month' && (
                        <div>
                          <div style={{ fontSize:10, color:'#64748b', marginBottom:4 }}>Місяць</div>
                          <select value={kalkaState.calendarMonth} onChange={e=>setKalkaState(p=>({...p,calendarMonth:+e.target.value,calendarMarkedDays:[]}))}
                            style={{ width:'100%', padding:'6px 8px', borderRadius:6, border:'1px solid #e2e8f0', fontSize:13, color:'#1e2d7d', fontWeight:600, background:'#fff', cursor:'pointer' }}>
                            {KALKA_UA_MONTHS.map((mn,mi)=><option key={mi} value={mi}>{mn}</option>)}
                          </select>
                        </div>
                      )}
                      <div>
                      ...
                      <div>
                        <div style={{ fontSize:10, color:'#64748b', marginBottom:4 }}>Шрифт</div>
                        <FontPicker value={kalkaState.calendarFont} onChange={f=>setKalkaState(p=>({...p,calendarFont:f}))} />
                      </div>
                      <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                      ...
                      {kalkaState.calendarMode==='month' && (
                        <div>
                          <div style={{ fontSize:10, color:'#64748b', marginBottom:4 }}>Обведення дат</div>
                          <div style={{ fontSize:10, color:'#94a3b8', lineHeight:1.4, marginBottom:6 }}>Натисніть на число в календарі, щоб обвести дату (наприклад, важливу).</div>
                          {kalkaState.calendarMarkedDays.length>0 && (
                            <div style={{ display:'flex', flexWrap:'wrap', gap:4 }}>
                              {kalkaState.calendarMarkedDays.slice().sort((a,b)=>a-b).map(d=>(
                                <button key={d} onClick={()=>setKalkaState(p=>({...p,calendarMarkedDays:p.calendarMarkedDays.filter(x=>x!==d)}))}
                                  style={{ padding:'2px 8px', borderRadius:999, border:'1px solid #c7d2fe', background:'#f0f3ff', color:'#1e2d7d', fontSize:11, fontWeight:700, cursor:'pointer' }}>
                                  {d} ×
                                </button>
                              ))}
                            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                {currentIdx === 0 ? (
                  ...
                  <button onClick={() => setTextTool(t => !t)}
                    ...
                    <Type size={15} /> {textTool ? '↖ ' + t('constructor.click_page') : t('constructor.add_text')}
                  </button>
                )}
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5 }}>
                    ...
                    <label style={{ width:24, height:24, borderRadius:'50%', border:'2px dashed #94a3b8', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', position:'relative', overflow:'hidden', flexShrink:0, background: !COLORS.includes(tColor) ? tColor : '#f8fafc' }} title="Обрати інший колір">
                      <span style={{ fontSize:14, color:'#94a3b8', lineHeight:1, pointerEvents:'none' }}>+</span>
                      <input type="color" value={tColor} onChange={e => { setTColor(e.target.value); if (selectedTextId) updateTxtForPage(selectedTextId, { color: e.target.value }, selectedTextPageIdx); }} style={{ position:'absolute', inset:0, opacity:0, width:'100%', height:'100%', cursor:'pointer' }}/>
                    </label>
                  </div>
                  <div style={{ display: 'flex', gap: 4 }}>
        ...
        <div
          ...
          <div style={{ position: 'sticky', top: isMobile ? 4 : 0, zIndex: 30, background: isMobile ? 'rgba(244,246,251,0.96)' : '#f4f6fb', backdropFilter: isMobile ? 'blur(6px)' : undefined, WebkitBackdropFilter: (isMobile ? 'blur(6px)' : undefined) as any, padding: isMobile ? '6px 10px' : '8px 0', borderRadius: isMobile ? 14 : 0, boxShadow: isMobile ? '0 2px 10px rgba(30,45,125,0.12)' : 'none', fontSize: 13, fontWeight: 700, color: '#1e2d7d', marginBottom: isMobile ? 8 : 12, display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0, alignSelf: 'center' }}>
            {isWishbook ? (
              <span>Обкладинка</span>
            ) : (<>
            <button onClick={() => setCurrentIdx(i => Math.max(0, i - 1))} disabled={currentIdx === 0} style={{ display:'flex', alignItems:'center', justifyContent:'center', background: isMobile ? '#eef2ff' : 'none', border: 'none', borderRadius: isMobile ? 999 : 0, width: isMobile ? 38 : undefined, height: isMobile ? 38 : undefined, cursor: currentIdx === 0 ? 'not-allowed' : 'pointer', opacity: currentIdx === 0 ? 0.3 : 1, color: '#1e2d7d', touchAction:'manipulation' }}><ChevronLeft size={isMobile ? 22 : 20} /></button>
            <span style={{ minWidth: isMobile ? 92 : undefined, textAlign:'center', whiteSpace:'nowrap' }}>{currentIdx === 0 ? t('constructor.cover') : (isMobile ? `Розворот ${currentIdx} / ${Math.ceil((pages.length - 1) / 2)}` : `${(currentIdx-1)*2+1}–${(currentIdx-1)*2+2}`)}</span>
            <button onClick={() => setCurrentIdx(i => Math.min(Math.ceil((pages.length - 1) / 2), i + 1))} disabled={currentIdx === Math.ceil((pages.length - 1) / 2)} style={{ display:'flex', alignItems:'center', justifyContent:'center', background: isMobile ? '#eef2ff' : 'none', border: 'none', borderRadius: isMobile ? 999 : 0, width: isMobile ? 38 : undefined, height: isMobile ? 38 : undefined, cursor: currentIdx === Math.ceil((pages.length - 1) / 2) ? 'not-allowed' : 'pointer', opacity: currentIdx === Math.ceil((pages.length - 1) / 2) ? 0.3 : 1, color: '#1e2d7d', touchAction:'manipulation' }}><ChevronRight size={isMobile ? 22 : 20} /></button>
            {currentIdx !== 0 && (() => {
              const activeIdx = getActivePageIdx();
                        ...
                        <div
                          ...
                          {backPhoto ? (
                            <>
                              ...
                              <div data-export-ignore="true" onPointerDown={e => { e.stopPropagation(); startBackSlotDrag(e, 'move'); }}
                  ...
                  {kalkaState.calendarEnabled && (
                    <div
                      onPointerDown={e => {
                        ...
                        startPointerDrag(e, (dx, dy) => {
                          if (Math.abs(dx) > 4 || Math.abs(dy) > 4) calDragMovedRef.current = true;
                      ...
                      <KalkaCalendar mode={kalkaState.calendarMode} year={kalkaState.calendarYear} month={kalkaState.calendarMonth} color={kalkaState.calendarColor} font={kalkaState.calendarFont} markedDays={kalkaState.calendarMarkedDays} baseFont={(pageW * kalkaState.calendarScale / 100) / 75} onToggleDay={day => { if (calDragMovedRef.current) { calDragMovedRef.current = false; return; } setKalkaState(p => ({ ...p, calendarMarkedDays: p.calendarMarkedDays.includes(day) ? p.calendarMarkedDays.filter(d => d !== day) : [...p.calendarMarkedDays, day] })); }} />
                    </div>
                  )}
                  {kalkaState.text && (
                    <div
                      ...
                      style={{
                        ...
                        transform: kalkaState.textAlign === 'left' ? 'translate(0, -50%)' : kalkaState.textAlign === 'right' ? 'translate(-100%, -50%)' : 'translate(-50%, -50%)',
                        maxWidth: '90%',
                        cursor: 'grab',
                        touchAction: 'none',
                        userSelect: 'none',
                      ...
                      return (
                        ...
                        <div
                          ...
                          onDrop={e => {
                            ...
                            // Single photo from the sidebar dropped ON a slot → REPLACE/fill THIS slot.
                            // Dropping on a slot always targets that slot (whether it's full or empty).
                            // To ADD a photo and grow the spread, drop on the empty canvas area or use
                            // Магічна збірка — that path is the canvas-level onDrop, not this per-slot one.
                            pushHistory();
                            setPages(prev => prev.map((p, pi) => pi !== spreadPageIdx ? p : { ...p, slots: p.slots.map((s2, si) => si !== i ? s2 : { ...s2, photoId, ...getFocalCrop(photoId) }) }));
                          }}
                          onClick={(e) => {
                            ...
                            <>
                              ...
                              <div style={{ width:'100%', height:'100%', overflow: photoEditSlot === key ? 'visible' : 'hidden', position:'relative', cursor: photoEditSlot === key ? 'crosshair' : 'default', padding: pageGap > 0 ? pageGap : 0, boxSizing:'border-box' }}
                                ...
                                onDrop={e => {
                                  ...
                                  // Sidebar photo dropped ON this slot → REPLACE/fill THIS slot (not add).
                                  pushHistory();
                      ...
                      {pageDefs.map(({ i, s }) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {editSlotKey === key && (
                              <div data-export-ignore="true" style={{position:'absolute',inset:0,pointerEvents:'none',zIndex:54}}>
                              <>
                                {/* Selection border */}
      ...
      {showTooltips && (() => {
        ...
        const photos = variant === 'wishbook' ? {
          ...
          tip: (() => {
            ...
            return pm > 0
              ? <>Для фотокниги потрібно щонайменше {pm} фото — по одному на кожну сторінку (більше — для колажів).</>
              : <>Завантажте щонайменше по одному фото на кожну сторінку (більше — для колажів).</>;
          })(),
        };
      ...
      {isMobile && (
        <div style={{ position:'fixed', bottom:0, left:0, right:0, background:'rgba(255,255,255,0.98)', backdropFilter:'blur(16px)', borderTop:'1px solid #e2e8f0', zIndex:200, paddingBottom:'env(safe-area-inset-bottom)', boxShadow:'0 -4px 20px rgba(0,0,0,0.08)' }}>
          ...
          <div style={{ display:'flex', alignItems:'stretch' }}>
            {([
              ...(!isWishbook ? [['photos', <ImageIcon size={19}/>, t('constructor.photo')]] : []),
                    ...
                    <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                      ...
                      {kalkaState.calendarMode==='month' && (
                        <div>
                          <div style={{ fontSize:10, color:'#64748b', marginBottom:4 }}>Місяць</div>
                          <select value={kalkaState.calendarMonth} onChange={e=>setKalkaState(p=>({...p,calendarMonth:+e.target.value,calendarMarkedDays:[]}))}
                            style={{ width:'100%', padding:'8px', borderRadius:6, border:'1px solid #e2e8f0', fontSize:14, color:'#1e2d7d', fontWeight:600, background:'#fff' }}>
                            {KALKA_UA_MONTHS.map((mn,mi)=><option key={mi} value={mi}>{mn}</option>)}
                          </select>
                        </div>
                      )}
                      ...
                      {kalkaState.calendarMode==='month' && (
                        <div>
                          <div style={{ fontSize:10, color:'#64748b', marginBottom:4 }}>Обведення дат</div>
                          <div style={{ fontSize:10, color:'#94a3b8', lineHeight:1.4, marginBottom:6 }}>Натисніть на число в календарі, щоб обвести дату.</div>
                          {kalkaState.calendarMarkedDays.length>0 && (
                            <div style={{ display:'flex', flexWrap:'wrap', gap:4 }}>
                              {kalkaState.calendarMarkedDays.slice().sort((a,b)=>a-b).map(d=>(
                                <button key={d} onClick={()=>setKalkaState(p=>({...p,calendarMarkedDays:p.calendarMarkedDays.filter(x=>x!==d)}))}
                                  style={{ padding:'3px 10px', borderRadius:999, border:'1px solid #c7d2fe', background:'#f0f3ff', color:'#1e2d7d', fontSize:12, fontWeight:700, cursor:'pointer' }}>
                                  {d} ×
                                </button>
                              ))}
                            </div>
