...
import { MAGAZINE_STAPLE_MAX_PAGES } from '@/lib/products';
...
const COVER_TYPES: CoverType[] = [
  {
    ...
    swatchColors: [
      '#F0EAD6','#D9C8B0','#7C7167','#E8B4B8', // Молочний, Бежевий, Таупе, Рожевий
      '#7A2838','#9A9898','#B8A8C8','#1A2040', // Бордо, Сірий перловий, Лаванда, Синій
      '#3A3038','#1A9090','#8C2D80','#607080', // Графітовий, Бірюзовий, Фіолетовий, Блакитно-сірий
      '#1A6A53','#D4A020',                     // Темно-зелений, Жовтий
    ],
    decorations: [
  ...
  const covers = {
    soft: {
      ...
      features: [
        ...
        // Поріг читається з коду, а не пишеться тут числом: до 24.09.2026 у
        // цьому рядку стояло 44, друкарня ж робить скобу до 52 включно, і
        // клієнт бачив на сторінці товару не те, що отримував у коробці.
        { icon: '', title: 'Скоба або клей', text: `До ${MAGAZINE_STAPLE_MAX_PAGES} сторінок — скоба, більший обсяг — термоклей. Лежить рівно.` },
      ],
