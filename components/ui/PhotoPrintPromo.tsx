                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {collageImages.map((src, idx) => (
                                <motion.div
                                    ...
                                    className={`relative aspect-square rounded-[8px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 group ${idx === 4 ? 'z-10 scale-105 shadow-md' : ''
                                        }`}
                                >
                                    <Image
                                        src={src}
