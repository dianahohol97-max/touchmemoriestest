                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    >
                        ...
                        <Link
                            ...
                            className="btn-primary inline-flex items-center justify-center px-10 py-5 bg-primary text-white font-black text-lg uppercase tracking-widest !rounded-full transition-all duration-300 hover:shadow-[0_20px_40px_rgba(38,58,153,0.3)] hover:-translate-y-1 group"
                        >
                            Замовити друк фото
