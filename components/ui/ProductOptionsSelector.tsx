...
const VELOUR_COLORS = [
  ...
  { code: 'В-11', name: 'Фіолетовий',      hex: '#8C2D80' },
  { code: 'В-12', name: 'Блакитно-сірий',  hex: '#607080' },
  { code: 'В-13', name: 'Темно-зелений',   hex: '#1A6A53' },
...
const PRODUCT_OPTIONS: ProductOptionsConfig = {
  photobook: [
    ...
    },
    {
      ...
      required: true,
      note: 'Стосується обкладинки фотокниги (друкована обкладинка ламінується глянцевою або матовою плівкою).'
    },
    {
