...
export function WeddingSectionClient({ weddingImages }: { weddingImages?: WeddingImages }) {
    const t = useT();
            ...
            products: [
                {
                    ...
                    image: weddingImages?.guestbook || '/images/wedding/guestbook.png',
                    href: '/catalog?category=guestbooks'
                },
                {
                    name: t('wedding.newspaper'),
                    image: weddingImages?.newspaper || '/images/wedding/newspaper.png',
            ...
            products: [
                {
                    ...
                    image: weddingImages?.photobook || '/images/wedding/photobook.png',
                    href: '/catalog?category=photobooks'
                },
                {
                    name: t('wedding.magazine'),
                    image: weddingImages?.magazine || '/images/wedding/magazine.png',
