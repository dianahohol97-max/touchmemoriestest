...
export function ProductOptions({ product }: ProductOptionsProps) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            {/* Quantity & Summary */}
            <div style={{ marginTop: '16px', padding: '32px', backgroundColor: '#f8fafc', borderRadius: '24px', border: '1px solid #eef2f6' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', backgroundColor: 'white', padding: '8px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', padding: '16px', backgroundColor: '#f0f9ff', borderRadius: '16px', color: '#0369a1', fontSize: '14px' }}>
                <Info size={18} />
