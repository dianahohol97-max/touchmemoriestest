...
export default function TravelbookConstructorPage() {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-[85vh] bg-[#FDFBF7] flex flex-col items-center justify-center font-sans">
        <div className="bg-white p-12 rounded-[2.5rem] shadow-xl text-center max-w-xl mx-4 border border-[#E9E4DB] animate-in zoom-in-95 duration-500">
          <div className="w-24 h-24 bg-amber-50 rounded-full flex items-center justify-center mx-auto mb-8 border-4 border-amber-100">
          ...
          <div className="bg-stone-50 border border-stone-100 rounded-2xl p-6 mb-8 inline-block shadow-inner w-full">
          ...
          <div className="bg-stone-50 rounded-2xl p-6 text-sm text-stone-600 font-medium mb-10 text-left flex flex-col gap-2">
            <div className="flex justify-between"><span className="text-stone-500">Кількість фото:</span> <span className="text-stone-900">{photos.length}</span></div>
            <div className="flex justify-between"><span className="text-stone-500">До сплати:</span> <span className="text-stone-900 font-bold">{formatUAH(totalPrice)}</span></div>
            <div className="flex justify-between"><span className="text-stone-500">Доставка:</span> <span className="text-stone-900 capitalize">{deliveryMethod.replace('_', ' ')}</span></div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] font-sans pb-20">
      ...
      <div className="relative h-[240px] md:h-[300px] w-full overflow-hidden bg-stone-900">
         <img 
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
        ...
        <div className="mb-8 max-w-5xl mx-auto flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <div className={`bg-white rounded-[2rem] shadow-xl border border-stone-100 ${step === 2 ? 'p-0 sm:p-6 lg:p-10 bg-transparent sm:bg-white border-none sm:border-solid shadow-none sm:shadow-xl' : 'p-6 md:p-10'} relative overflow-hidden max-w-5xl mx-auto`}>
          ...
          {step === 1 && (
             <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between mb-8 pb-6 border-b border-stone-100">
                <div>
                ...
                <div className="bg-stone-50 border border-stone-200 rounded-xl px-4 py-3 flex items-center shadow-inner">
                   <div className="w-8 h-10 border-2 border-stone-300 rounded bg-white mr-3 flex items-center justify-center shadow-sm">
                      <span className="text-[10px] font-black text-stone-400">A4</span>
                   </div>
                   <div>
                       <div className="text-[11px] font-bold uppercase tracking-widest text-stone-400">Fixed Format</div>
                       <div className="font-extrabold text-stone-800">A4 (21×29.7 cm)</div>
                   </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                <div className="lg:col-span-7 space-y-10">
                  ...
                  <div>
                    ...
                    <div className="bg-white p-6 rounded-[1.5rem] border border-stone-200 shadow-sm">
                      ...
                      <div className="flex items-start text-sm text-amber-900 bg-amber-50/70 p-4 rounded-xl border border-amber-100">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="p-6 rounded-[1.5rem] border border-stone-200 bg-white shadow-sm flex flex-col sm:flex-row gap-5 hover:border-amber-200 transition-colors">
                          ...
                          <div className="text-sm font-black text-stone-900 bg-stone-100 border border-stone-200 px-4 py-2 rounded-xl flex items-center justify-center h-min shadow-sm whitespace-nowrap">
                            +{5 * pages} UAH
                          </div>
                      </div>
                ...
                <div className="lg:col-span-5 hidden sm:block">
                  <div className="bg-[#1f1a17] rounded-[2rem] p-8 text-stone-100 sticky top-24 shadow-2xl overflow-hidden border border-stone-800">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-amber-600/10 blur-[80px] rounded-full pointer-events-none" />
                    
                    <div className="flex items-center justify-center mb-8 border-b border-stone-800 pb-5">
                    ...
                    <div className="space-y-4 mb-8">
                      ...
                      {lamination !== 'none' && (
                        <div className="flex justify-between items-start text-[14px] text-stone-500">
                    ...
                    <div className="bg-[#FAF8F5] rounded-2xl p-5 shadow-inner">
            ...
            <div className="animate-in fade-in zoom-in-95 duration-500">
              <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-7 space-y-12 bg-white sm:rounded-[2rem] sm:p-1 p-0">
                  ...
                  {/* Info Box */}
                  <div className="bg-stone-50 border border-stone-200 p-6 rounded-[1.5rem] shadow-sm">
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                        ...
                        {deliveryMethod === 'nova_poshta' && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6 bg-stone-50 rounded-2xl border border-stone-200 animate-in slide-in-from-top-4 fade-in">
                            <div>
          ...
          {/* Navigation Buttons */}
          <div className="mt-10 pt-6 border-t border-stone-200 flex items-center justify-between z-20 relative bg-white">
            {step === 2 ? (
              <button 
                onClick={handleBack}
          ...
          {/* Mobile sticky cart */}
          {step === 2 && (
            <div className="block sm:hidden border-t border-stone-100 mt-10 pt-6">
               <OrderSummary 
                 productName={`Travel Book`}
                 basePrice={basePrice}
                 totalPrice={totalPrice}
