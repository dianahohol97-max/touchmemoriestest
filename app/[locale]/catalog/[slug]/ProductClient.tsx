...
import { imgProduct, imgThumbnail } from '@/lib/supabaseImage';
        ...
        <div style={{ minHeight: '100vh', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', overflowX: 'hidden' }}>
                                            ...
                                            onClick={() => {
                                                ...
                                                if (base.includes('/order/book') && (Object.keys(customProductOptions).length > 0 || photobookOptions)) {
                                                    const keyMap: Record<string, string> = {
                                                        ...
                                                        'Варіант акрилу': 'decoration_variant',
                                                        'Варіант фотовставки': 'decoration_variant',
            ...
            <GuestBookConfigModal
                ...
                initialConfig={{
                    ...
                    decoVariant: String(customProductOptions['Варіант оздоблення'] || ''),
                }}
            />
