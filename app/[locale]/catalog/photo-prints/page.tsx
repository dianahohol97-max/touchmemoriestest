...
const TYPE_SPECS: Record<string, { name: string; description: string; specs: string[] }> = {
  ...
  polaroid: {
    name: 'Два формати · матовий або глянцевий · папір Fuji',
    description: 'Фото в стилі Polaroid — два формати на вибір. Надруковано на папері Fuji, фотохімічний друк. Ідеально для декору, подарунків та мотузок зі спогадами.',
    specs: [
      '7.6 × 10.1 см — класичний вертикальний (кратно 8 шт)',
      '8.6 × 5.4 см — горизонтальний міні-формат (кратно 10 шт)',
      'Ціна: 7.5 ₴/шт для обох форматів',
      'Матовий або глянцевий папір Fuji',
      'Виготовлення: 1–3 робочі дні',
      'Від 200 фото — знижка 7%',
    ],
  },
      ...
      <main style={{ flex: 1, padding: '140px 20px 80px', maxWidth: '800px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ backgroundColor: '#f8fafc', padding: '24px', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '16px', border: '1px solid #f1f5f9' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '14px', color: '#475569', fontWeight: 500 }}>
            ...
            Термін виготовлення: 2–4 робочих дні
          </div>
        </div>
      </main>
