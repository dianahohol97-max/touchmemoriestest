...
const META_I18N: Record<string, { title: (g: string, p: string) => string; desc: (p: string) => string; fallbackTitle: string; fallbackDesc: string; anon: string }> = {
  ...
  pt: { title: (g, p) => `${g} — galeria de fotos de ${p}`, desc: p => `Veja e descarregue as suas fotos. A galeria está disponível durante 30 dias. Fotógrafo: ${p}.`, fallbackTitle: 'A sua galeria de fotos', fallbackDesc: 'Veja e descarregue as fotos do seu fotógrafo.', anon: 'fotógrafo' },
