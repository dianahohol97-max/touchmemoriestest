...
const FAQ: Array<{ q: string; a: string }> = [
    {
        ...
        a: 'Тревел-агенції та тревел-блогери. Залиште заявку на цій сторінці — після схвалення ви отримаєте персональне реферальне посилання і доступ до партнерського кабінету. Для фотографів діє окрема програма на сторінці «Для фотографів».',
    },
    {
        q: 'Скільки заробляє партнер?',
        a: 'Комісія — 5% від вартості тревелбуків і 3% від решти товарів із кожного оплаченого замовлення за вашим посиланням. Нарахування відбувається автоматично після оплати.',
    },
    {
        q: 'Що отримує клієнт за партнерським посиланням?',
        a: 'Знижку 5% на замовлення. Вона застосовується автоматично: клієнт переходить за вашим посиланням і бачить нову суму вже в кошику, вводити нічого не треба.',
    },
    {
