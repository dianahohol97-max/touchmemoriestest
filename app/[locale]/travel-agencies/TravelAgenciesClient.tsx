...
const MODELS = [
    {
        ...
        description: 'Даруйте клієнтам сертифікат на тревелбук після подорожі — приємний бонус, який збереже спогади про їхню поїздку. Ви купуєте сертифікати оптом зі знижкою, а клієнти повертаються до вас із теплими емоціями.',
        perks: ['Оптова знижка на сертифікати', 'Ваші клієнти отримують подарунок', 'Нічого не потрібно виробляти самим'],
    },
    {
        id: 'referral',
        icon: Percent,
        ...
        description: 'Ваша агенція отримує персональний промокод зі знижкою для клієнтів, а ви — відсоток з кожного замовлення за цим кодом. Менеджерам вигідно рекомендувати нас — це додатковий дохід без жодних витрат.',
        perks: ['Персональний промокод агенції', 'Відсоток з кожного замовлення', 'Оплата лише за реальні продажі'],
    },
    {
        id: 'cobranded',
        icon: BookHeart,
