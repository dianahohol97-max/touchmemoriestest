...
const MODELS = [
    ...
    },
    {
        ...
        description: 'Ваша агенція отримує персональний промокод зі знижкою для клієнтів, а ви — винагороду з кожного замовлення за цим кодом: 10% від вартості тревелбуків і 3% від вартості решти товарів. Менеджерам вигідно рекомендувати нас — це додатковий дохід без жодних витрат.',
        perks: ['Персональний промокод агенції', '10% за тревелбуки, 3% за інші товари', 'Оплата лише за реальні продажі'],
    },
