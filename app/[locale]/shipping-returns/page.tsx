                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            ...
                            <div className="bg-white p-8 rounded-[3px] shadow-sm border border-gray-100">
                                ...
                                <ul className="text-gray-600 leading-relaxed space-y-3">
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="text-emerald-600 font-bold">•</span>
                                        <span>Всі замовлення виконуються за передоплатою або ж повною оплатою. Оскільки кожен продукт виготовляється індивідуально під ваше замовлення, ми не можемо розпочати роботу без підтвердження оплати.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
