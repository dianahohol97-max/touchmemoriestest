...
const TITLE = 'Онлайн-галереї для фотографів — передавайте фото клієнтам';
const DESCRIPTION = 'Онлайн-галереї для фотографів: брендована галерея за посиланням, уся зйомка архівом і вибір фото для друку. Безкоштовно на 4 ГБ, платні тарифи від 149 грн.';
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'На безкоштовному тарифі галерея зберігається 30 днів від створення, без продовження. На платних тарифах термін ви обираєте самі, 30, 60 або 90 днів, і за потреби продовжуєте його в кабінеті. Клієнт бачить лічильник днів. Клієнт завантажує всю зйомку одним архівом на комп\'ютері або кількома частинами на телефоні, а будь-яке фото можна зберегти окремо.',
  },
  {
...
export default async function GalleryForPhotographersPage({ params }: Props) {
  ...
  const serviceLd = {
    ...
    '@type': 'Service',
    '@id': pageUrl,
    name: 'Онлайн-галереї для фотографів',
    description: DESCRIPTION,
    ...
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '48px 20px 90px', fontFamily: 'Arial, sans-serif', color: '#1f2937' }}>
      ...
      <section style={{ textAlign: 'center', marginBottom: 56 }}>
        ...
        <p style={{ fontSize: 17, color: '#475569', maxWidth: 640, margin: '0 auto 24px', lineHeight: 1.6 }}>
          ...
          і зберігання від 30 до 90 днів залежно від тарифу. Клієнт завантажує всю зйомку одним архівом на комп'ютері або кількома частинами на телефоні, а будь-яке фото можна зберегти окремо.
        </p>
      ...
      <section style={{ marginBottom: 56 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 14 }}>
          {[
            { icon: '', title: 'Галереї для клієнтів', text: 'Створюйте галерею на кожну зйомку, завантажуйте до 2000 фото і діліться особистим посиланням. Клієнт дивиться знімки у лайтбоксі. Клієнт завантажує всю зйомку одним архівом на комп\'ютері або кількома частинами на телефоні, а будь-яке фото можна зберегти окремо.' },
