...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Створіть кабінет прямо на цій сторінці — потрібні лише імʼя, email і пароль. Кабінет із галереями та сторінкою-візиткою доступний одразу, без заявок і модерації. Знижка 10% на фотокниги, журнали та фотодрук вмикається автоматично разом із кабінетом — достатньо увійти в акаунт із тією самою поштою під час замовлення.',
  },
];
