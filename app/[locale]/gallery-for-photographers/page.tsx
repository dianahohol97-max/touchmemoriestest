...
const FAQ = [
  {
    ...
    a: 'Кабінет фотографа, галереї для клієнтів і сторінка-візитка з портфоліо та прайсом — безкоштовні. Платною є лише опція власного домену для вашої сторінки.',
  },
  {
  ...
  },
  {
    ...
    a: 'Напишіть нам на hello@touchmemories.com.ua — ми створимо ваш кабінет і надішлемо особисте посилання. Налаштування займає кілька хвилин.',
  },
];
...
export default async function GalleryForPhotographersPage({ params }: Props) {
  ...
  const mailto = 'mailto:hello@touchmemories.com.ua?subject=' + encodeURIComponent('Кабінет фотографа на Touch.Memories');
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '48px 20px 90px', fontFamily: 'Arial, sans-serif', color: '#1f2937' }}>
      ...
      <section style={{ textAlign: 'center', marginBottom: 56 }}>
        ...
        <a href={mailto} style={{ display: 'inline-block', background: '#1e2d7d', color: '#fff', borderRadius: 10, padding: '14px 28px', fontWeight: 800, textDecoration: 'none', fontSize: 16 }}>
          Отримати кабінет безкоштовно
        </a>
        <div style={{ fontSize: 13, color: '#94a3b8', marginTop: 10 }}>Без реєстрацій і паролів — кабінет за особистим посиланням</div>
      </section>
      ...
      <section style={{ marginBottom: 56 }}>
        ...
        <ol style={{ margin: 0, paddingLeft: 0, listStyle: 'none', display: 'grid', gap: 12 }}>
          {[
            'Напишіть нам — створимо ваш кабінет і надішлемо особисте посилання на пошту.',
