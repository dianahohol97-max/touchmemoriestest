...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Створіть кабінет прямо на цій сторінці — потрібні лише імʼя, email і пароль. Кабінет із галереями та сторінкою-візиткою доступний одразу, без заявок і модерації. Знижка 10% на друк і заробіток з рекомендацій оформлюються окремо — заявкою фотографа з портфоліо, яку ми розглядаємо вручну.',
  },
];
