...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Заповніть коротку форму реєстрації для фотографів. Після підтвердження заявки ви отримаєте лист із посиланням на кабінет, а знижка 10% активується у вашому акаунті автоматично.',
  },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '48px 20px 90px', fontFamily: 'Arial, sans-serif', color: '#1f2937' }}>
      ...
      <section style={{ textAlign: 'center', marginBottom: 56 }}>
        ...
        <div style={{ fontSize: 13, color: '#94a3b8', marginTop: 10 }}>Одна реєстрація = галереї + візитка + знижка 10% на товари</div>
      </section>
      ...
      <section style={{ marginBottom: 56 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 14 }}>
          {[
            ...
            { icon: '💰', title: 'Знижка 10% на товари', text: 'Як партнер-фотограф ви отримуєте постійну знижку 10% на фотокниги, журнали, фотодрук і travel book для клієнтських проєктів.' },
      ...
      <section style={{ marginBottom: 56 }}>
        ...
        <ol style={{ margin: 0, paddingLeft: 0, listStyle: 'none', display: 'grid', gap: 12 }}>
          {[
            'Заповніть форму реєстрації для фотографів — після підтвердження отримаєте лист із кабінетом, а знижка 10% увімкнеться в акаунті.',
