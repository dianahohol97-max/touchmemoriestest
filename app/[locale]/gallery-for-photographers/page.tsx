...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Створіть кабінет прямо на цій сторінці — потрібні лише імʼя, email і пароль. Галереї та сторінка-візитка запрацюють одразу, без модерації. Знижка 10% на друк і заробіток з рекомендацій живуть у цьому ж кабінеті й вмикаються після схвалення заявки фотографа з портфоліо, яку ми розглядаємо вручну.',
  },
];
