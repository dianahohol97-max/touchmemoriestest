...
const FAQ: { q: string; a: string }[] = [
    ...
    },
    {
        ...
        a: 'На безкоштовному тарифі галерея зберігається 30 днів без продовження. На платних тарифах термін ви обираєте самі при створенні галереї, 30, 60 або 90 днів, і за потреби продовжуєте його в кабінеті. Після завершення терміну файли видаляються автоматично, а клієнт бачить сторінку з вашими контактами.',
    },
    {
