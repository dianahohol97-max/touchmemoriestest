...
const FAQ: { q: string; a: string }[] = [
    ...
    },
    {
        ...
        a: 'Так, у галерею можна додавати відео до 2 ГБ, і будь-яке з них можна поставити на обкладинку — тоді воно програватиметься на весь екран, коли клієнт відкриє галерею.',
    },
];
