...
const BENEFITS: { n: string; title: string; text: string }[] = [
    {
        ...
        text: 'Завантажуйте фото зйомки і надсилайте клієнту особисте посилання з вашим логотипом. Фото зберігаються від 30 до 90 днів залежно від тарифу, клієнт забирає їх одним ZIP-архівом, реєстрація йому не потрібна.',
    },
    {
        n: '02',
