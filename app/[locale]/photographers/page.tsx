...
const DESCRIPTION =
    ...
    + 'конструктор дизайну галереї, десять мов, відео на платних тарифах, знижка 10% на друк і заробіток з рекомендацій. '
...
const FAQ: { q: string; a: string }[] = [
    ...
    },
    {
        ...
        a: 'Ви надсилаєте йому особисте посилання на галерею. Реєстрація клієнту не потрібна: він відкриває сторінку і переглядає знімки. Клієнт завантажує всю зйомку одним архівом на комп\'ютері або кількома частинами на телефоні, а будь-яке фото можна зберегти окремо.',
    },
    {
        q: 'Скільки зберігаються фото в галереї?',
        a: 'На безкоштовному тарифі галерея зберігається тридцять днів без продовження. На платних тарифах термін ви обираєте самі при створенні галереї, тридцять, шістдесят або девʼяносто днів, і за потреби продовжуєте його в кабінеті. Після завершення терміну файли видаляються автоматично, а клієнт бачить сторінку з вашими контактами.',
    },
    {
    ...
    },
    {
        ...
        a: 'Так, від тарифу «Старт». У галерею можна додавати відео до 2 ГБ, і будь-яке з них можна поставити на обкладинку, тоді воно програватиметься на весь екран, коли клієнт відкриє галерею. На безкоштовному тарифі галерея приймає тільки фото.',
    },
];
...
const BENEFITS: { n: string; title: string; text: string }[] = [
    {
        ...
        text: 'Завантажуйте фото зйомки і надсилайте клієнту особисте посилання з вашим логотипом. Фото зберігаються від 30 до 90 днів залежно від тарифу, а реєстрація клієнту не потрібна. Клієнт завантажує всю зйомку одним архівом на комп\'ютері або кількома частинами на телефоні, а будь-яке фото можна зберегти окремо.',
    },
    {
        n: '02',
                ...
                <section style={{ background: 'linear-gradient(135deg, #263A99 0%, #1a2a73 100%)', padding: '64px 16px 72px', color: '#fff' }}>
                    <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
                        ...
                        <p style={{ fontSize: 16.5, lineHeight: 1.7, opacity: 0.9, maxWidth: 600, margin: '0 auto 32px' }}>
                            Один кабінет із усім, що потрібно для роботи з клієнтами: галереї для передачі фото, знижка 10% на друк і заробіток з рекомендацій.
                        </p>
                ...
                <section style={{ padding: '0 16px 80px' }}>
                    <div style={{ maxWidth: 1160, margin: '0 auto' }}>
                        ...
                        <p style={{ fontSize: 13.5, lineHeight: 1.7, color: '#8B8378', textAlign: 'center', maxWidth: 640, margin: '20px auto 0' }}>
                            Кабінет і галереї безкоштовні на тарифі з 4 ГБ місця. Постійна знижка 10% на друк і заробіток з рекомендацій вмикаються після схвалення вашої заявки з портфоліо.
                        </p>
                    </div>
                </section>
                ...
                <section id="tarify" style={{ background: '#F5EFE6', padding: '64px 16px 72px' }}>
                    <div style={{ maxWidth: 1160, margin: '0 auto' }}>
                        ...
                        <p style={{ fontSize: 14.5, lineHeight: 1.7, color: '#8B8378', textAlign: 'center', maxWidth: 660, margin: '0 auto 28px' }}>
                            Платні тарифи дають більше місця, термін зберігання до 90 днів із продовженням і відео в галереї. Конструктор дизайну, десять мов, статистика і вибір клієнта для друку доступні на кожному тарифі, включно з безкоштовним.
                        </p>
