    ...
    return (
        <B2bRegisterPage
            ...
            benefits={[
                ...
                'Онлайн-галереї для передачі фото клієнтам: особисте посилання і зберігання від 30 до 90 днів залежно від тарифу. Клієнт завантажує всю зйомку одним архівом на комп\'ютері або кількома частинами на телефоні, а будь-яке фото можна зберегти окремо.',
