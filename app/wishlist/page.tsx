...
const productName = { fontSize: '18px', fontWeight: 800, color: '#1e293b' };
...
const addToCartBtn = { flex: 1, backgroundColor: '#1e293b', color: 'white', border: 'none', borderRadius: '16px', fontWeight: 800, padding: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer' };
...
const outOfStockOverlay = { position: 'absolute' as any, top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(255,255,255,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 900, color: '#1e293b', letterSpacing: '0.1em' };
