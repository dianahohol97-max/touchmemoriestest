                ...
                <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
                        ...
                        <button
                            ...
                            style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '3px', fontWeight: 700, fontSize: '15px', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
                        >
                    ...
                    {loading ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '80px 20px', backgroundColor: 'white', borderRadius: '3px', border: '1px solid #e2e8f0' }}>
                            ...
                            <button
                                onClick={() => router.push('/catalog')}
                                style={{ padding: '12px 24px', backgroundColor: '#263A99', color: 'white', border: 'none', borderRadius: '3px', fontWeight: 700, cursor: 'pointer' }}
                            >
                                Перейти до каталогу
                            </button>
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '24px' }}>
                            {orders.map((order) => (
                                <motion.div
                                    ...
                                    style={{ backgroundColor: 'white', borderRadius: '3px', padding: '24px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9' }}
                                >
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px', marginBottom: '20px' }}>
                                        <div>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                                                ...
                                                <span style={{ padding: '4px 10px', backgroundColor: order.order_status === 'delivered' ? '#dcfce7' : '#f1f5f9', color: order.order_status === 'delivered' ? '#166534' : '#475569', borderRadius: '3px', fontSize: '12px', fontWeight: 700 }}>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '16px', marginBottom: '24px' }}>
                                        {order.items?.map((item: any, idx: number) => (
                                            <div key={idx} style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                                                <div style={{ width: '48px', height: '48px', backgroundColor: '#f8fafc', borderRadius: '3px', flexShrink: 0, overflow: 'hidden' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'flex-end', paddingTop: '16px', borderTop: '1px solid #f1f5f9' }}>
                                        <button
                                            ...
                                            style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', backgroundColor: 'white', border: '1.5px solid var(--primary)', color: 'var(--primary)', borderRadius: '3px', fontWeight: 700, fontSize: '14px', cursor: repeatingOrderId === order.id ? 'not-allowed' : 'pointer', opacity: repeatingOrderId === order.id ? 0.7 : 1, transition: 'all 0.2s' }}
                                        >
