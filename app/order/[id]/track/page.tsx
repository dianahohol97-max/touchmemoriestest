    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#fcfcfc' }}>
            ...
            <main style={{ padding: '140px 20px 80px', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div style={{ backgroundColor: 'white', padding: '48px', borderRadius: '32px', boxShadow: '0 4px 30px rgba(0,0,0,0.03)', border: '1px solid #f0f0f0' }}>
                    ...
                    {/* Delivery Details */}
                    {order.ttn && (
                        <div style={{ marginTop: '60px', padding: '32px', backgroundColor: '#f0f9ff', borderRadius: '24px', border: '1px solid #e0f2fe' }}>
