  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <p style={{ color: '#64748b', marginBottom: 28, fontSize: 14 }}>
        Реферальна програма: агенція отримує 5% з тревелбуків і глянцевих журналів та 3% з решти товарів за своїм промокодом; клієнт за кодом/посиланням отримує знижку 5%. Нарахування рахуються автоматично при оплаті.
      </p>
