...
// Styles
const refreshBtnStyle = { display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', backgroundColor: 'white', borderRadius: '12px', border: '1.5px solid #e2e8f0', color: '#64748b', fontWeight: 800, fontSize: '14px', cursor: 'pointer' };
...
const thumbStyle = { width: '44px', height: '44px', borderRadius: '10px', backgroundColor: '#f8fafc', overflow: 'hidden', border: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center' };
const statusBadgeStyle = { padding: '6px 12px', borderRadius: '100px', fontSize: '12px', fontWeight: 800 };
const iconActionBtnStyle = { width: '38px', height: '38px', borderRadius: '10px', backgroundColor: '#f8fafc', border: '1px solid #f1f5f9', color: '#64748b', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: 'all 0.2s' };
...
const modalContentStyle = { backgroundColor: 'white', borderRadius: '32px', width: '100%', maxWidth: '550px', padding: '40px', boxShadow: '0 25px 60px rgba(0,0,0,0.15)', position: 'relative' as any };
