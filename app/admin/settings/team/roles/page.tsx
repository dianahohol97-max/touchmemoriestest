                    ...
                    roles.map(role => (
                        <div key={role.id} style={roleCardStyle}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                                ...
                                {role.is_system && (
                                    <span style={{ fontSize: '11px', fontWeight: 800, color: '#94a3b8', backgroundColor: '#f1f5f9', padding: '4px 8px', borderRadius: '6px', textTransform: 'uppercase' }}>Системна</span>
                                )}
                            </div>
...
const tableCaseStyle = { border: '1px solid #f1f5f9', borderRadius: '16px', overflow: 'hidden' };
const labelStyle = { display: 'block', fontSize: '13px', fontWeight: 700, color: '#475569', marginBottom: '8px' };
const inputStyle = { width: '100%', padding: '12px 16px', borderRadius: '12px', border: '1.5px solid #e2e8f0', outline: 'none', fontSize: '15px' };
