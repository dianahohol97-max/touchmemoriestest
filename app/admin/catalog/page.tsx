                                        ...
                                        <td style={{ padding: '16px 24px', textAlign: 'right' }}>
                                            <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                                                <button
                                                    ...
                                                    style={{ padding: '8px', borderRadius: '8px', border: 'none', background: product.is_popular ? '#fef3c7' : '#f8fafc', color: product.is_popular ? '#d97706' : '#94a3b8', cursor: 'pointer' }}
                                                ...
                                                <Link
                                                    ...
                                                    style={{ padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8fafc', color: '#64748b', cursor: 'pointer' }}
                                                >
                                                    <Edit2 size={18} />
                                                </Link>
                                                <button
