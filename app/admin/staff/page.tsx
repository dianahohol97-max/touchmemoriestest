                                ...
                                <tr key={member.id} style={{ borderBottom: '1px solid #f1f5f9', opacity: member.is_active ? 1 : 0.6 }}>
                                    <td style={{ padding: '16px 24px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                            <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: member.color, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700, fontSize: '14px', flexShrink: 0 }}>
                                                {member.initials}
                                            </div>
                                            <div>
                                    ...
                                    <td style={{ padding: '16px 24px' }}>
                                        <span style={{ padding: '4px 12px', backgroundColor: '#f1f5f9', color: '#475569', borderRadius: '100px', fontSize: '13px', fontWeight: 600 }}>
                                            {getRoleLabel(member)}
                                        </span>
                                    </td>
                                    ...
                                    <td style={{ padding: '16px 24px' }}>
                                        <span style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', fontWeight: 600, color: member.is_active ? '#10b981' : '#94a3b8' }}>
                                            <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: member.is_active ? '#10b981' : '#cbd5e1' }} />
                                    ...
                                    <td style={{ padding: '16px 24px', textAlign: 'right' }}>
                                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px' }}>
                                            ...
                                            <button
                                                ...
                                                style={{ width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '10px', backgroundColor: member.is_active ? '#fef2f2' : '#ecfdf5', color: member.is_active ? '#ef4444' : '#10b981', border: 'none', cursor: 'pointer', transition: 'all 0.2s' }}
                            ...
                            <div style={{ display: 'grid', gap: '20px' }}>
                                ...
                                <div style={{ borderTop: '1px solid #f1f5f9', paddingTop: '20px', marginTop: '10px' }}>
                                    ...
                                    {hasIndividualOverride && (
                                        <div style={{ maxHeight: '200px', overflowY: 'auto', border: '1px solid #f1f5f9', borderRadius: '12px', padding: '12px' }}>
