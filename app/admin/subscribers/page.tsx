...
const TEMPLATES = [
    { id: 't1', name: ' Акція / знижка', subject: ' Спеціальна пропозиція від Touch.Memories',
      body: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a"><h2 style="color:#1e2d7d">Привіт! </h2><p>У нас для тебе особлива пропозиція:</p><div style="background:#f0f3ff;border-left:4px solid #1e2d7d;padding:16px;border-radius:8px;margin:16px 0"><strong> Знижка 20% на всі фотокниги до кінця тижня!</strong></div><p>Скористайся промокодом: <strong style="color:#1e2d7d">MEMORIES20</strong></p><a href="https://touchmemories.com.ua/catalog" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#1e2d7d;color:#fff;text-decoration:none;border-radius:8px;font-weight:600">Перейти до каталогу →</a></div>` },
    { id: 't2', name: ' Новий продукт', subject: ' Новинка в Touch.Memories!',
      body: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a"><h2 style="color:#1e2d7d">Новинка вже тут! </h2><p>Ми додали новий продукт, який тебе точно здивує.</p><p><strong>[Назва продукту]</strong> — [короткий опис]</p><a href="https://touchmemories.com.ua/catalog" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#1e2d7d;color:#fff;text-decoration:none;border-radius:8px;font-weight:600">Дізнатись більше →</a></div>` },
