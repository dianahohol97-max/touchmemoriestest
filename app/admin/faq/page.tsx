                ...
                {loading ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        ...
                        {filteredFaqs.length === 0 && (
                            <div style={{ textAlign: 'center', padding: '60px', borderRadius: '24px', backgroundColor: '#f8fafc', border: '1px dashed #e2e8f0' }}>
...
const actionBtnStyle = { width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '10px', border: '1.5px solid #f1f5f9', backgroundColor: 'white', color: '#64748b', cursor: 'pointer', transition: 'all 0.2s' };
