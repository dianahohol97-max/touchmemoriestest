                                    ...
                                    {(order.monobank_payment_url || paymentLink) ? (
                                        ...
                                        >
                                            {creatingPaymentLink ? (
                                                ...
                                                <>
                                                    {/* Кнопка нічого нікуди не надсилає: вона
                                                        створює рахунок Monobank і копіює посилання
                                                        в буфер. Надсилає лист сусідня синя кнопка
                                                        «Надіслати посилання клієнту», і поки обидві
                                                        називалися «надіслати», менеджер міг бути
                                                        певен, що клієнт уже отримав лист. */}
