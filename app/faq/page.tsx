...
const searchInput = { width: '100%', padding: '24px 32px 24px 64px', borderRadius: '24px', border: 'none', backgroundColor: 'white', boxShadow: '0 20px 50px rgba(0,0,0,0.06)', fontSize: '18px', outline: 'none', transition: 'all 0.3s' };
...
const tabStyle = { padding: '10px 20px', borderRadius: '14px', fontSize: '14px', fontWeight: 700, cursor: 'pointer', transition: 'all 0.3s', outline: 'none' };

const faqListContainer = { display: 'flex', flexDirection: 'column' as any, gap: '16px' };
const faqItemStyle = { borderRadius: '24px', padding: '20px 32px', cursor: 'default', transition: 'all 0.3s' };
