...
describe('лендінги партнерської програми', () => {
    ...
    describe('хаб співпраці', () => {
        ...
        it('веде на всі чотири профільні сторінки', () => {
            // Напрямів чотири, і хаб мусить показувати всі: меню «Співпраця»
            // веде саме сюди, тож напрям, якого тут немає, не має жодних дверей.
