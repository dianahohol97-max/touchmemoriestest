...
SET
    name = 'Travel Book',
    short_description = 'Формат 20×30 см. Глянцевий папір, тверда обкладинка, персональний дизайн.',
    description = 'Travel Book — це преміальний формат 20×30 см (книжкова орієнтація). Тверда обкладинка, друк на глянцевому папері, професійний макет у подарунок.
